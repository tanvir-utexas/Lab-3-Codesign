...
from nets.cifar_MobileNetv2 import mobilenetv2
...
parser.add_argument('--log_name', type=str, default='mobilenet_w1a32')
parser.add_argument('--pretrain', action='store_true', default=False)
parser.add_argument('--pretrain_dir', type=str, default='./ckpt/mobilenet_baseline')
...
cfg.log_name = 'mobilenet_w{}a{}'.format(cfg.Wbits, cfg.Abits)
if cfg.percentile < 1.0:
  cfg.log_name = 'mobilenet_w{}a{}p{}'.format(cfg.Wbits, cfg.Abits, cfg.percentile)
...
def main():
  ...
  model = mobilenetv2(wbits=cfg.Wbits, abits=cfg.Abits, percentile=cfg.percentile).cuda()
  ...
  for epoch in range(cfg.max_epochs):
    ...
    test(epoch)
    lr_schedu.step()
    torch.save(model.state_dict(), os.path.join(cfg.ckpt_dir, cfg.log_name))
