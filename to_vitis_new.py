...
def csv_conv_tensor(tensor, path='./new_weights/', name = ''):
    """
...
def csv_bias_tensor(tensor, path='./new_weights/', name = ''):
    """
...
def csv_lin_tensor(tensor, path='./new_weights/', name = ''):
    """
    Function to convert conv tensor data to 2D CSV file
...
def csv_dict(dict, path='./new_weights/', name = ''):
